	...
	<div class="titolo">
		<div class="container ">
			<div class="row ">
				...
				<div class="row pipe_sanita" style="padding-top: 2%">
...
<div class="col-md-4 col-xs12 triangle_sanita">
				<div class="card card-content" style="min-height: 320px">
...
<?php  if(get_field('etichetta_executive_program')) { ?>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 col-xs12 triangle_sanita">
				<div class="card card-content" style="min-height: 280px">
					<h3 class="card-title"> <a title="<?php the_title();?>" href="<?php the_permalink();
?>" class=""> <span class="a-card" > <?php    the_title(); ?></span></a> </h3>
					<div class="card-action">
						<div class="col-md-5 col-xs12" style="border-right: 1px solid #ebebeb">
