            ...
            <div class="row">
                <div class="col-md-12 mb-48 mt-48">
                    <div class="footer-logos w-100">
                        <h3 class="color__blue pb-48"><?php echo $certificazioni_riconoscimenti[ICL_LANGUAGE_CODE]; ?>
                        </h3>
                        <ul style="display:flex; flex-direction: row; justify-content: space-between; flex-wrap: wrap;">
                            ...
                            <li><a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/"
                                    target="_blank"><img
                                        src="<?php echo site_url() ?>/wp-content/uploads/2018/01/ISO_9001_2015_BW.jpg"
                                        alt="Azienda con sistema di Gestione qualità certificato da DNV GL iISO 9001"
                                        class="img-responsive" /></a></li>
                            <li> <a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/"
                                    target="_blank"><img
                                        src="<?php echo site_url() ?>/wp-content/uploads/2015/05/asfor-ordinario-footer-bw.jpg"
                            ...
                            <li> <a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/"
                                    target="_blank"><img
                                        src="<?php echo site_url() ?>/wp-content/uploads/2015/05/rep-luiss-footer-bw.jpg"
                            ...
                            <li> <a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/"
                                    target="_blank"><img
                                        src="<?php echo site_url() ?>/wp-content/uploads/2018/06/grli_BW.png"
                                        alt="LUISS Business School è partner GRLI – Globally Responsible Leadership Initiative"
                                        width="100" class="img-responsive" /></a></li>
                            <li> <a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/"
                                    target="_blank"><img
                                        src="<?php echo site_url() ?>/wp-content/uploads/2018/06/prme_BW_rev.png"
                                        alt="LUISS Business School è membro PRME – United Nations Principles for Responsible Management Education (PRME)."
                                        width="100" class="img-responsive" /></a></li>

                            <li> <a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/"
                                    target="_blank"><img
                                        src="<?php echo site_url() ?>/wp-content/uploads/2019/01/business-educational-alliance-logoBN.png"
                                        alt="LUISS Business School è membro  AACSB " width="100 "
                                        class="img-responsive" /></a></li>
                            <li> <a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/"
                                    target="_blank"><img
                                        src="<?php echo site_url() ?>/wp-content/uploads/2019/08/GBSN-150.png"
                                        alt="Global Business School Network" width="150 " class="img-responsive" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="juicer-feed"
                                    data-feed-id="luissbusiness-9274faa2-d37a-4a26-bd24-d134adebd1bb" data-per="6"
                                    data-gutter="10"></ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row pt-80 pb-24" style="border-bottom: 1px solid #fff;">
                    <div class="col-xs-12 col-md-8 px-0">
                      ...
                      We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
                        ...
                        <div id="mc_embed_signup">
                            <form
                                action="https://luiss.us4.list-manage.com/subscribe/post?u=fbe9a604a26369735b564dc99&amp;id=5e790bb539"
                                ...
                                <div id="mc_embed_signup_scroll">
                                    ...
                                    <div id="mergeRow-gdpr"
                                        ...
                                        <div class="content__gdpr">
                                            ...
                                            <p>Do you consent to the processing of your personal information for
                                                promotional purposes, relevant news and information about programmes at
                                                LUISS Business School? You may unsubscribe at any time.</p>
                                            <fieldset class="mc_fieldset gdprRequired mc-field-group"
                                                name="interestgroup_field">
                                                <label class="checkbox subfield" for="gdpr_1"><input type="checkbox"
                                                        id="gdpr_1" name="gdpr[1]" value="Y"
                                                        class="av-checkbox gdpr"><span>Yes, I consent</span> </label>
                                            </fieldset>
                                    ...
                                    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input
                                            type="text" name="b_fbe9a604a26369735b564dc99_5e790bb539" tabindex="-1"
                                            value=""></div>
                                    <div class="clear">
                                        <input type="submit" value="Subscribe" name="subscribe"
                                            id="mc-embedded-subscribe" class="button button__primary"
                                            style="background-color: #cc8a00 !important;">
                                    </div>
                                </div>
                            </form>
                            <p><a href="//businessschool.luiss.it/informativa-sul-trattamento-dei-dati-personali-newsletter/"
                                    class="color__gold">Informativa sul trattamento dei dati personali</a></p>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-4 px-0">
                        ...
                        <ul class="footer-socials list-inline">
                            <li><a href="https://www.facebook.com/pages/LUISS-Business-School/152306674798769"><span
                                        class="social-icon icon-facebook"></span></a></li>
                            <li><a href="https://twitter.com/LUISSBusiness"><span
                                        class="social-icon icon-twitter"></span></a></li>
                            <li><a href="https://instagram.com/luissbusiness/"><span
                                        class="social-icon icon-instagram "></span></a> </li>
                            <li><a href="https://www.flickr.com/photos/luissbusiness/albums"><span
                                        class="social-icon icon-flickr"></span></a> </li>
                            <li><a href="https://www.youtube.com/user/luissmba"><span
                                        class="social-icon icon-youtube"></span></a> </li>
                            <li><a href="https://www.linkedin.com/school/luiss-business-school/"><span
                                        class="social-icon icon-linkedin"></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row px-0 pt-24 pb-64">
                <div class="col-xs-12 px-lg-0">
                    <p>The PMI Registered Education Provider logo is a registered mark of the Project Management
                        Institute, Inc. <br>
                        Use of this website constitutes acceptance of <a href="/cookies/"
                            style="color: #fdbb4d; font-size: 1rem;">Cookie Policy</a>.<br>
                        © LUISS Business School Villa Blanc,Via Nomentana, 216 00162 Roma, Italia - Centralino T 06
                        852251 - P.IVA 01067231009 </p>
                </div>
            </div>
        </div>
    </div>
...
<script async data-main="<?php echo get_bloginfo('template_url') ?>/js/app"
    src="<?php echo get_bloginfo('template_url') ?>/js/require.js"></script>
...
<noscript>
    <img height="1" width="1" style="display:none;" alt=""
        src="https://px.ads.linkedin.com/collect/?pid=1751300&fmt=gif" />
</noscript>
