                        ...
                        <div id="mc_embed_signup">
                            <form action="https://luiss.us4.list-manage.com/subscribe/post?u=fbe9a604a26369735b564dc99&amp;id=5e790bb539" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate px-0 pt-0 pb-32" target="_blank" novalidate>
                                <div id="mc_embed_signup_scroll">
                                    ...
                                    <div class="clear">
                                        <input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button button__primary" style="background-color: #cc8a00 !important;"></div>
                                </div>
                            </form>
                            <p><a href="//businessschool.luiss.it/informativa-sul-trattamento-dei-dati-personali-newsletter/" class="color__gold">Informativa sul trattamento dei dati personali</a></p>
                        </div>
