...
?>
  ...
  <p style="font-weight: 800;"><?php echo get_post_meta($post->ID, 'classificazione', true); ?> <br /> <?php echo get_post_meta($post->ID, 'insegnamento', true); ?> <br /> <a href="mailto: . <?php echo get_post_meta($post->ID, 'email', true); ?>  . "/> <?php echo get_post_meta($post->ID, 'email', true); ?></a>
</p>
    </div>
    </div>
