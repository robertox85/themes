	...
	<!--		<div class="container">
				...
				<div class="carousel-caption">
					<h2><span><?php // echo html_entity_decode($desc3); ?></span></h2>
					 <p><span class="slider_paragraf"><strong><?php // echo html_entity_decode($testo3_3); ?></strong></span></p> 
				</div>
...
<div class="container">
<div class="row">
       <div class="col-md-12"> <a href="//businessschool.luiss.it/master-sperimentazione-clinica/"><img src="//businessschool.luiss.it/wp-content/uploads/2018/10/banner_Sperimentazione_Clinica.jpg" class="img-responsive" alt="Sperimentazione clinica: aspetti regolatori, gestionali e operativi" /></a>
       </div>
	 </div>
</div>-->
