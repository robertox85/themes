    ...
    <div class="row sub-home-list">
      <div class="sub-home-grid">
        ...
        <div class="col-md-8 nopadding">
          <div class="sub-home-item-info"> <img  src="<?php echo get_site_url() ?>/wp-content/uploads/2015/05/EXECUTIVE-PROGRAMMES-Prendi-il-controllo-della-tua-carriera.jpg" alt="Prendi-il-controllo-della-tua-carriera"  class="img-responsive"/> </div>
        </div>
      </div>
    </div>
  </div>
 ...
 ?>
    <div class="col-lg-3 columns panel course-part-time">
      <div class="text"> <a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>">
        ...
        <span class="course-start-date"><?php echo get_date(get_field('data_inizio'),"standard"); ?>&nbsp;</span> 
      </a> </div></div>
    <?php
	}	
