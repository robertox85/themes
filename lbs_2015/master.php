...
?>
	...
	<div class="container-fluid px-0 box-cover-off d-flex flex-column align-items-start  justify-content-center" style="background-image:url(<?php echo site_url() ?>/wp-content/themes/lbs_2015/pco/images/offerta-formativa/master.jpg)">
	    <div class="container">
	        <div class="row">
	            <div class="col-xs-12">
...
<div class="modal fade" id="videoModal" tabindex="-1" role="dialog" aria-labelledby="videoModalLabel" aria-hidden="true">
  ...
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/7VuI-HXka6s" allowfullscreen></iframe>
        ...
        -->       
	                ...
	                <a class="button button__primary my-8 mr-md-16 my-8 mr-md-16" href="https://www.youtube.com/watch?v=7VuI-HXka6s&feature=emb_title" target="_blank">Watch the video</a>
	            </div>
	            <div class="col-md-6 intro">
	            </div>
	        </div>
	...
	<div class="container">
	    ...
	    <section>
	        ...
	        <ul class="nav nav-tabs auto mx-0 px-0 d-flex flex-row flex-wrap flex-lg-nowrap flex-xl-nowrap" id="program-type" role="tablist">
	            <!-- ROMA -->
	            <li class="nav-item active"><a class="nav-link active" id="tab1-tab" data-toggle="tab" href="#roma" role="tab" aria-controls="tab1" aria-selected="true"><?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></a></li>
	                    ...
	                    <div class="d-flex flex-row px-0 pt-24 align-items-stretch justify-content-start  flex-wrap">
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_34[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_34[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_34[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 34 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_21[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_21[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_21[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 21 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_14[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_14[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_14[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 14 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_15[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_15[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_15[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 15 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_16[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_16[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_16[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 16 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_6[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_6[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_6[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 6 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_4[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_4[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_4[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 4 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_5[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_5[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_5[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 5 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_8[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_8[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_8[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 8 -->
<!--
...
-->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_37[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_37[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_37[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 37 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_22[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_22[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_22[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 22 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_1[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_1[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_inizio[ICL_LANGUAGE_CODE] ?></strong> <?php echo $inizio_master_1[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $lingua[ICL_LANGUAGE_CODE] ?></strong> <?php echo $lingua_corso_en[ICL_LANGUAGE_CODE] ?></p>
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                <a class="button button__secondary my-8 mr-sm-16 mr-md-0 mr-lg-16" href="<?php echo $link_site_master_1[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_site[ICL_LANGUAGE_CODE] ?></a>
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_1[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 1 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_9[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_9[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_9[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 9 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_10[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_10[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_10[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 10 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_11[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_11[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_11[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 11 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_32[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_32[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_32[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 32 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_31[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_31[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_31[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 31 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_25[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_25[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_25[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 25 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_29[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_29[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_29[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 29 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_27[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_27[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_27[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 27 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_30[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_30[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_30[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 30 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_38[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_38[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_38[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 38 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_41[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_41[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_41[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 41 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_39[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_39[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_39[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 39 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_40[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_40[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_40[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 40 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_42[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_42[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_42[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 42 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_19[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_19[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_19[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 19 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_20[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_20[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_20[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 20 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_35[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 35 -->
                    ...
                    <div class="d-flex flex-row px-0 pt-24 align-items-stretch justify-content-start  flex-wrap">
	                        <!-- MASTER 45 -->
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            <div class="first-block"><span class="meta text-uppercase color__grey"><?php echo $secondo_livello[ICL_LANGUAGE_CODE] ?></span>
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_45[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_45[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_45[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 45 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_50[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_50[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_50[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 50 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_24[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_24[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_24[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 24 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_46[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_46[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_46[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 46 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_47[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_47[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_part[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_47[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 47 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_48[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_48[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_part[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_48[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 48 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_49[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_49[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_part[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_49[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 49 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_44[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_44[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_44[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 44 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_43[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_43[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_43[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 43 -->
                    ...
                    <div class="d-flex flex-row px-0 pt-24 align-items-stretch justify-content-start  flex-wrap">
	                        ...
	                        <div class="card-course-small card__blue p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_programma_a1[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_programma_a1[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_inizio[ICL_LANGUAGE_CODE] ?></strong> <?php echo $inizio_programma_a1[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $lingua[ICL_LANGUAGE_CODE] ?></strong> <?php echo $lingua_corso_it[ICL_LANGUAGE_CODE] ?></p>
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                <a class="button button__secondary button__blue my-8 mr-sm-16 mr-md-0 mr-lg-16" href="<?php echo $link_site_programma_a1[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_site[ICL_LANGUAGE_CODE] ?></a>
	                                <a class="button button__primary button__blue my-8 m-md-0" href="<?php echo $link_brochure_programma_a1[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END PROGRAMMA A1 -->
	                        ...
	                        <div class="card-course-small card__blue p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_programma_a2[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_programma_a2[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full_11[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_rm[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_inizio[ICL_LANGUAGE_CODE] ?></strong> <?php echo $inizio_programma_a2[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $lingua[ICL_LANGUAGE_CODE] ?></strong> <?php echo $lingua_corso_en[ICL_LANGUAGE_CODE] ?></p>
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                <a class="button button__secondary button__blue my-8 mr-sm-16 mr-md-0 mr-lg-16" href="<?php echo $link_site_programma_a2[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_site[ICL_LANGUAGE_CODE] ?></a>
	                                <a class="button button__primary button__blue my-8 m-md-0" href="<?php echo $link_brochure_programma_a2[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END PROGRAMMA A2 -->
	                        ...
	                        <div class="card-course-small card__blue p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_programma_a3[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_programma_a3[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            ...
	                            <p class="big mb-8"><strong><?php echo $lingua[ICL_LANGUAGE_CODE] ?></strong> <?php echo $lingua_corso_it[ICL_LANGUAGE_CODE] ?></p>
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                <a class="button button__secondary button__blue my-8 mr-sm-16 mr-md-0 mr-lg-16" href="<?php echo $link_site_programma_a3[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_site[ICL_LANGUAGE_CODE] ?></a>
	                                <a class="button button__primary button__blue my-8 m-md-0" href="<?php echo $link_brochure_programma_a3[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END PROGRAMMA A3 -->
	                        ...
	                        <div class="card-course-small card__blue p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_programma_a4[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_programma_a4[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                    ...
	                    <div class="d-flex flex-row px-0 pt-24 align-items-stretch justify-content-between  flex-wrap">
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_18[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_18[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_18[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 18 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_23[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_23[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_23[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 23 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_2[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_2[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_mi[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_2[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 2 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_12[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_12[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_mi[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_12[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 12 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_33[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_33[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_mi[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_33[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 33 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_26[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_26[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_mi[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_26[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 26 -->
	                    ...
	                    <div class="d-flex flex-row px-0 pt-24 align-items-stretch justify-content-start flex-wrap">
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_17[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_17[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_17[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 17 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_7[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_7[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_be[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_7[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 7 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_36[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_36[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_be[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_36[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 36 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_13[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_13[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_be[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_13[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 13 -->
	                        ...
	                        <div class="card-course-small p-24 mx-0 mx-md-16 my-16 d-flex flex-column justify-content-between align-items-start" style="border-color: var(--current-color);">
	                            ...
	                            <h6 class="py-24 mb-0"><?php echo $titolo_master_28[ICL_LANGUAGE_CODE] ?>
	                                <br /><?php echo $sottotitolo_master_28[ICL_LANGUAGE_CODE] ?></h6></div><div class="second-block">
	                            <p class="big mb-8"><strong><?php echo $titolo_durata[ICL_LANGUAGE_CODE] ?></strong> <?php echo $durata_full[ICL_LANGUAGE_CODE] ?></p>
	                            <p class="big mb-8"><strong><?php echo $titolo_sede[ICL_LANGUAGE_CODE] ?></strong> <?php echo $sede_be[ICL_LANGUAGE_CODE] ?></p>
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_28[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a></div>
	                            </div>
	                        </div>
	                        <!-- END MASTER 28 -->
