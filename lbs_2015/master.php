	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-6 intro">
	                ...
	                <a class="button button__primary my-8 mr-md-16 my-8 mr-md-16" href="https://www.youtube.com/watch?v=7VuI-HXka6s&feature=emb_title">Watch the video</a>
	            </div>
	            <div class="col-md-6 intro">
	            </div>
	        </div>
	    ...
	    <section>
	        ...
	        <div class="tab-content my-0 my-md-48" id="ProgramType">
	            ...
	            <div class="tab-pane fade active in show" id="roma" role="tabpanel" aria-labelledby="roma-tab">
	                ...
	                <div class="row">
	                    <div class="col-xs-12 mb-24 mb-md-48">
	                        <h3><?php echo $primo_livello[ICL_LANGUAGE_CODE] ?></h3>
	                    </div>
	                    <div class="d-flex flex-row align-items-stretch justify-content-between flex-wrap">
	                        <!-- MASTER 34 -->
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_34[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 34 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_14[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 14 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_15[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 15 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_16[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 16 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_4[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 4 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_1[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 1 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_9[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 9 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_10[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 10 -->
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_24[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 24 -->
	                    ...
	                    <div class="d-flex flex-row align-items-stretch justify-content-between flex-wrap">
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_18[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 18 -->
	                        ...
	                        <div class="card-course-small p-24 m-16 d-flex flex-column justify-content-start align-items-start">
	                            ...
	                            <div class="mt-24 d-flex flex-row justify-content-between align-items-center flex-wrap flex-lg-nowrap ctas">
	                                ...
	                                <a class="button button__primary my-8 m-md-0" href="<?php echo $link_brochure_master_2[ICL_LANGUAGE_CODE] ?>"><?php echo $titolo_link_brochure[ICL_LANGUAGE_CODE] ?></a>
	                            </div>
	                        </div>
	                        <!-- END MASTER 2 -->
