    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4">
                <p class="big">L’esperienza di apprendimento è costruita intorno alla persona e ad ogni percorso sono associati attività e servizi che si sviluppano, durante e dopo la fase di aula e completano il percorso formativo scelto.</p>
                <p class="big">Le sessioni di EduCare sono studiate promuovere lo sviluppo professionale e personale e generare un impatto immediato sul business e sul contesto organizzativo di riferimento.</p>
            </div>
            <div class="col-xs-12 col-md-8">
                <div class="row">
                    <div class="col-xs-12">
                        <h5>Sviluppo Personale</h5>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        <h6>L4E - Leader for Executive</h6>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <h6>Mentoring</h6>
                        <p>Il Mentoring supporta i partecipanti affidandoli a manager esperti e leader di comprovato spessore con i quali condividere esperienze e conoscenze.
