<div class="container">
    <div class="row">
	 ...
	 if(get_field('testo_inizio')) { echo '<div class="block"><p class="color__white text-uppercase p-0">' . get_field('testo_inizio') . '</p>';}
	...
	if (get_field('data_inizio')) {  echo '<div class="textwidget"><h6 class="color__white">' . $date->format('d/m/Y') . '</h6></div> </div>';}
		 ...
		 if(get_field('data_inizio_testuale')) { echo '<div class="block"><p class="color__white text-uppercase p-0">' . get_field('data_inizio_testuale') . '</p>';}
	...
	if (get_field('data_fine')) {  echo '<div class="textwidget"><h6 class="color__white">' . $date_m->format('d/m/Y') . '</h6></div> </div>';}
		 ...
		 if(get_field('veneto')) { echo '<div class="block"><p class="color__white text-uppercase p-0">' . get_field('veneto') . '</p>';}
	...
	{
echo '<div class="block"><p class="color__white text-uppercase p-0">'. get_field('titolo_costo').'</p><div class="textwidget"><h6>'. get_field('costo').'</h6></div> </div>';
    }
			
			 if(get_field('titolo_durata')) { echo '<div class="block"><h6 class="color__white">'. get_field('titolo_durata').'</h6>' ; }
             if(get_field('durata')) { echo '<div class="textwidget"><p class="color__white text-uppercase p-0">'. get_field('durata') .'</p></div> </div>'; }
			
			
						if(get_field('codice_corso'))
	{
echo '<div class="block"><h6 class="color__white">'. get_field('testo_codice_corso').'</h6><div class="textwidget"><p class="color__white text-uppercase p-0">'. get_field('codice_corso').'</p></div> </div>';
    }
		 ?>
				...
				if ( get_field( 'key_facts' ) ) {
					echo '<div class="block"><h6 class="color__white">' . get_field( 'key_facts' ) . '</h6><div class="textwidget"><p class="color__white text-uppercase p-0">' . get_field( 'campo_key_facts' ) . '</p></div> </div>';
				}
