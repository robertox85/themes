        ...
        <div class="col-xs-12 col-lg-8 w-100 keyfacts-box">
            ...
            <div class="d-flex flex-row flex-lg-nowrap flex-wrap justify-content-start align-items-start align-items-lg-center">
                ...
                if(get_field('data_veneto')) {
                    ...
                    echo '<div class="block pr-16  pr-lg-48"><p class="color__white text-uppercase p-0 mt-lg-32 mb-lg-16 mt-16 mb-8">'. get_field('titolo_costo').'</p><div class="textwidget"><h6 class="color__white mt-0 mb-32">'. get_field('costo').'</h6></div></div>';
                    }
                    ...
                    echo '<div class="block pr-16  pr-lg-48"><p class="color__white text-uppercase p-0 mt-lg-32 mb-lg-16 mt-16 mb-8">'. get_field('testo_codice_corso').'</p><div class="textwidget"><h6 class="color__white mt-0 mb-32">'. get_field('codice_corso').'</h6></div> </div>'; }
                
                    ?>

                    <?php
                    if ( get_field( 'key_facts' ) ) {
					echo '<div class="block pr-16  pr-lg-48"><p class="color__white text-uppercase p-0 mt-lg-32 mb-lg-16 mt-16 mb-8">' . get_field( 'key_facts' ) . '</p><div class="textwidget"><h6 class="color__white mt-0 mb-32">' . get_field('campo_key_facts') . '</h6></div> </div>'; }
                    ?>
            </div>
