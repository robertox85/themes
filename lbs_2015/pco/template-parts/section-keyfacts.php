<div class="container">
	 ...
	 if(get_field('testo_inizio')) { echo '<div class="block"><h3 class="color__white">' . get_field('testo_inizio') . '</h3>';}
	...
	if (get_field('data_inizio')) {  echo '<div class="textwidget"><p class="color__white">' . $date->format('d/m/Y') . '</p></div> </div>';}
		 ...
		 if(get_field('data_inizio_testuale')) { echo '<div class="block"><h3 class="color__white">' . get_field('data_inizio_testuale') . '</h3>';}
	...
	if (get_field('data_fine')) {  echo '<div class="textwidget"><p class="color__white">' . $date_m->format('d/m/Y') . '</p></div> </div>';}
		 ...
		 if(get_field('veneto')) { echo '<div class="block"><h3 class="color__white">' . get_field('veneto') . '</h3>';}
	...
	{
echo '<div class="block"><h3 class="color__white">'. get_field('titolo_costo').'</h3><div class="textwidget"><p>'. get_field('costo').'</p></div> </div>';
    }
			
			 if(get_field('titolo_durata')) { echo '<div class="block"><h3 class="color__white">'. get_field('titolo_durata').'</h3>' ; }
