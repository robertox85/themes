...
<script>
  ...
  fbq('init', '2077128595659831');
  fbq('track', 'PageView');
  fbq('track', 'CompleteRegistration');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=2077128595659831&ev=PageView&noscript=1"
/></noscript>
...
<!-- Global site tag (gtag.js) - Google Ads: 769785431 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-769785431"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-769785431');
</script>
...
})(window,document,'script','dataLayer','GTM-W82Z6FJ');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W82Z6FJ"
