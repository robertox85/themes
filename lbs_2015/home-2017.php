...
_6 = Programmi di alta formazione - non utilizzato
            <!-- Box MBA -->
            <div class="col-md-5 card-course p-24 my-16 d-flex flex-column align-items-start justify-content-between">
            ...
            <!-- Box Master -->
            <div class="col-md-5 offset-md-1 card-course p-24 my-16 d-flex flex-column align-items-start justify-content-between">
            ...
            <div class="col-md-5 offset-md-1 card-course p-24 m-16 d-flex flex-column align-items-start justify-content-between">
