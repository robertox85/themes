   ...
   <?php edit_post_link('<p class="button arr featured-links">Modifica Pagina</p>', ''); ?>
    <div class="row">
      <div class="col-md-8 sx">
       <img  src="/wp-content/uploads/2015/05/EXECUTIVE-PROGRAMMES-Prendi-il-controllo-della-tua-carriera.jpg" alt="Prendi-il-controllo-della-tua-carriera"  class="img-responsive"/>
