<?php
/*
Template Name: Soft 2017
*/
get_header(2017);
?>
<?php   $sub_intro = array();
		$sub_intro['it'] = 'Sviluppare la leadership significa allenarsi costantemente a rafforzare una serie di competenze che vanno dalla capacità di ispirare l&#8217;&#8220;extra-ordinario&#8221;, attraverso la comunicazione e l&#8217;influenza, alla capacità di motivare, di negoziare, di gestire la complessità e il tempo, di guidare team. &Egrave; su queste competenze che la LUISS Business School lavora, proponendo corsi che rappresentano esperienze uniche per sviluppare un approccio concreto al cambiamento.';
   ...
   <?php edit_post_link('<p class="button arr featured-links">Modifica Pagina</p>', ''); ?>
    <div class="row">
      <div class="col-md-8 sx">
       <img  src="<?php echo get_site_url() ?>/wp-content/uploads/2015/05/EXECUTIVE-PROGRAMMES-Prendi-il-controllo-della-tua-carriera.jpg" alt="Prendi-il-controllo-della-tua-carriera"  class="img-responsive"/>
