    ...
    <div class="row">
     ...
     <?php edit_post_link('<p class="button arr featured-links">Modifica Pagina</p>', ''); ?>
      <div class="col-md-8 sx">
       <img  src="<?php echo get_site_url() ?>/wp-content/uploads/2015/07/Banking-Insurance-And-Other-Financial-Institutions.jpg" alt="Prendi-il-controllo-della-tua-carriera"  class="img-responsive"/>
