  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 sx">
       <img  src="/wp-content/uploads/2015/07/accounting-finance-control.jpg" alt="Prendi-il-controllo-della-tua-carriera"  class="img-responsive"/>
...
?>" class="col-md-4 master-preview">
        <div class="course-item" style="padding: 5px">
...
?>
            ...
            <h3  class="course-info  nopadding col-md-5"> <span class="glyphicon glyphicon-tags"></span> Start:</h3> 
