    ...
    <div class="row sub-home-list">
      <div class="sub-home-grid">
        ...
        <div class="col-md-8 nopadding">
          <div class="sub-home-item-info"><img  src="http://businessschool.luiss.it/wp-content/uploads/2017/05/villaBlanc_NEWS_Eventi.jpg" alt="Sede LUISS Business School Viale Pola 12"  class="img-responsive"/></div>
        </div>
      </div>
    </div>
  </div>
