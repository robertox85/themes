         ...
         <h2 class="headline"><?php echo $certificazioni_riconoscimenti[ICL_LANGUAGE_CODE]; ?></h2>
          <div class="footer-logos">
            <ul>
              ...
              </li>  <li> <a href="<?php echo site_url() ?>/perche-luiss-bs/certificazioni-e-riconoscimenti/" target="_blank"><img src="<?php echo site_url() ?>/wp-content/uploads/2018/06/grli_BW.png" alt="LUISS Business School è partner GRLI – Globally Responsible Leadership Initiative"  width="100" class="img-responsive" /></a></li>
...
<form action="https://luiss.us4.list-manage.com/subscribe/post?u=fbe9a604a26369735b564dc99&amp;id=5e790bb539" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<div id="mergeRow-gdpr" class="mergeRow gdpr-mergeRow content__gdprBlock mc-field-group">
    <div class="content__gdpr">
		...
		<label class="checkbox subfield" for="gdpr_1"><input type="checkbox" id="gdpr_1" name="gdpr[1]" value="Y" class="av-checkbox gdpr"><span>YES</span> </label>
        </fieldset>
...
<!--End mc_embed_signup-->
         ...
         <p><a href="//businessschool.luiss.it/informativa-sul-trattamento-dei-dati-personali-newsletter/" style="color: #FDBB4D; padding-left: 2%">Informativa sul trattamento dei dati personali</a></p>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          Use of this website constitutes acceptance  of the <a href="http://businessschool.luiss.it<?php echo $privacy[ICL_LANGUAGE_CODE]; ?>" style="color: #fff">Privacy Policy</a> and <a href="/cookies/" style="color: #fff">Cookie Policy</a>.<br>
