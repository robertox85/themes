...
<div class="container-fluid px-0 box-cover-off d-flex flex-column align-items-center  justify-content-start marketing-cover">
...
<div class="container">
    ...
    <section>
        ...
        <ul class="nav nav-tabs auto mx-0 px-0 d-flex flex-row flex-nowrap" id="program-type" role="tablist">
            ...
            <!-- COURSES -->
            <li class="nav-item"><a class="nav-link" id="tab4-tab" data-toggle="tab" href="#excourses" role="tab" aria-controls="tab4" aria-selected="false"><?php echo $executive_course_label[ICL_LANGUAGE_CODE] ?></a></li>
