<?php
/*
Template Name: People 2017
*/
get_header( 2017 );
?> <?php $sub_intro = array();
$sub_intro[ 'it' ] = 'Persone e processi eccellenti sono l’essenza di ogni organizzazione di successo. I nostri programmi di executive education forniscono conoscenze, metodologie e strumenti per valorizzare e gestire in modo strategico il capitale umano e disegnare architetture organizzative innovative in grado di supportare efficacemente i piani di sviluppo dell’organizzazione.';
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 sx">
        ...
        <div class="sub-home-item-info">   <img  src="<?php echo get_site_url() ?>/wp-content/uploads/2015/07/accounting-finance-control.jpg" alt="Prendi-il-controllo-della-tua-carriera"  class="img-responsive"/></div>
