...
<?php   $link_infrastructure = array();
		$link_infrastructure['it'] = '/offerta-formativa/executive-program/real-estate/real-estate-infrastructure/';
		$link_infrastructure['en'] = '/en/programs/executive-program/area-real-estate-infrastructure-in-luiss-bs/';
?>

<?php   $titolo_tavolo = array();
		$titolo_tavolo['it'] = 'Steering Committee Real Estate & Infrastructure';
		$titolo_tavolo['en'] = 'Steering Committee Real Estate & Infrastructure';
?>

<?php   $subtitolo_tavolo = array();
		$subtitolo_tavolo['it'] = 'I nostri responsabili organizzativi';
		$subtitolo_tavolo['en'] = 'Our high-level advisors ';
?>

<?php   $link_tavolo = array();
		$link_tavolo['it'] = '/offerta-formativa/executive-program/real-estate/tavolo-infrastrutture-real-estate/';
		$link_tavolo['en'] = '/en/programs/executive-program/steering-committe-real-estate/';
?>
...
<section class="body-section">
  <div class="container">
        ...
        <div class="text">
         <h3 class="block-title h2"><a href="<?php echo $link_infrastructure[ICL_LANGUAGE_CODE]; ?>"> Real Estate & Infrastructure </a></h3>
        
          <p>Il Lab Real Estate & Infrastructure di LUISS Business School è la nuova piattaforma dedicata alla crescita professionale e alla produzione e divulgazione della culture nel settore immobiliare e delle infrastrutture.</p>
        </div>
        </a> </div>
      ...
      <div class="col-lg-6 columns">
        <div class="text">
         <h3 class="block-title h2" ><a href="<?php echo $link_tavolo[ICL_LANGUAGE_CODE]; ?>"><?php echo $titolo_tavolo[ICL_LANGUAGE_CODE]; ?> </a></h3>
         
          <p><?php echo $subtitolo_tavolo[ICL_LANGUAGE_CODE]; ?></p>
        </div>
        </a> </div>
    </div>
  </div>
