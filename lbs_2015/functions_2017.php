...
function register_taxonomy_area_competenze() {
    ...
    register_taxonomy( 'area_competenze', array('post' ,'page' ,'evento'), $args );
}
...
//add_filter( 'body_class', 'sp_body_class' );
//function sp_body_class( $classes ) {
//	if (is_page_template(array("master.php")))
	//	$classes[] = 'master';
	//	return $classes;
//}
...
//add_filter( 'body_class', 'sp_body_class' );
//function sp_body_class( $classes ) {
//	if (is_page_template(array("offerta.php" , "master.php")))
//		$classes[] = 'offerta';
//		return $classes;
//}
