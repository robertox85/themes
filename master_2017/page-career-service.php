...
<div class="container">
  <div class="row">
    <nav class="navbar navbar-default navbar-master">
      ...
      <?php wp_nav_menu(array( 'menu'=> 'Master', 'container_id' => 'menu-master-container', 'container_class' => 'menu-master-container navbar-collapse collapse', 'container' => 'div', 'menu_class' => 'menu-master nav navbar-nav', )); ?>
    </nav>
  </div>
</div>
    ...
    <main id="main" class="site-main site-master col-lg-9 col-md-8" role="main">
      <div id="page-content" class="columns  space">
        ...
        <!--<div class="row">
          ...
          <a href="<?php // the_field('img_link_1'); ?>" data-lightbox="<?php // the_field('img_lightbox_1'); ?>" data-title="<?php // the_field('img_title_1'); ?>">    
        
         <img class="img-responsive" src="<?php // the_field('img_1'); ?>" alt="<?php  //the_field('img_1'); ?>"/>
        
        </a>

      
       <a href="<?php //  the_field('img_link_2'); ?>" data-lightbox="<?php  //the_field('xx'); ?>" data-title="<?php  //the_field('img_title_2'); ?>">    
        
         <img class="img-responsive" src="<?php // the_field('xxxx'); ?>" alt="<?php //the_field('xxxx'); ?>"/>
